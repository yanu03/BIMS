...
@Service
public class MO0201Service extends ServiceSupport{

	 Logger logger = LoggerFactory.getLogger(this.getClass());
	
	@Autowired
	private MO0201Mapper mo0201Mapper;
	...
	public List MO0201G0R0() throws Exception{
		Map param = getSimpleDataMap("dma_search");
		return mo0201Mapper.MO0201G0R0(param);
	}
	
	public List MO0201G1R0() throws Exception{
		Map param = getSimpleDataMap("dma_search");
		return mo0201Mapper.MO0201G1R0(param);
	}
	
	public List MO0201SHI0() throws Exception{
		return mo0201Mapper.MO0201SHI0();
	}
	
	public List MO0201SHI1() throws Exception{
		Map param = getSimpleDataMap("dma_search");		
		return mo0201Mapper.MO0201SHI1(param);
	}
	
	public List MO0201G2R0() throws Exception {
		// TODO Auto-generated method stub
		Map param = getSimpleDataMap("dma_search");
		return mo0201Mapper.MO0201G2R0(param);
	}
	
	public List MO0201G3R0() throws Exception {
		// TODO Auto-generated method stub
		Map param = getSimpleDataMap("dma_search");
	...
	public List selectCategory() throws Exception {
		// TODO Auto-generated method stub
		Map param = getSimpleDataMap("dma_search");
		return mo0201Mapper.selectCategory(param);
	}
	
	public List selectSigOper() throws Exception {
		// TODO Auto-generated method stub
		Map param = getSimpleDataMap("dma_search");
		return mo0201Mapper.selectSigOper(param);
	}
	
	public List selectSigPeriod() throws Exception {
		// TODO Auto-generated method stub
		return mo0201Mapper.selectSigPeriod();
	}	

	public List<Map> MO0201SCK() throws Exception{
	...
	public List selectCommuMap() throws Exception{
		return mo0201Mapper.selectCommuMap();
	}
	
	//신호등 현시 요청 소켓
	public List<Map> MO0201SCK2() throws Exception{
		...
		try {
			...
			if(false) { //DB에서 TOD에 따른 현시 조회
				for (int i=0; i<param.size(); i++) {
					...
					int phaseNo = mo0201Mapper.selectCurPhaseNo(paramMap);
