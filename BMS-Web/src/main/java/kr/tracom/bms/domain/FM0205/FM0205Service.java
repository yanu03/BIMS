...
import kr.tracom.bms.domain.FM0205.FM0205Mapper;
...
@Service
public class FM0205Service extends ServiceSupport {
	...
	@Autowired
	private FM0205Mapper FM0205Mapper;
	...
	public List FM0205G0R0() throws Exception {
		Map param = getSimpleDataMap("dma_search");
		return FM0205Mapper.FM0205G0R0(param);
	}
	
	public List FM0205G0R1() throws Exception {
		...
		return FM0205Mapper.FM0205G0R1();
	}
	
	public List FM0205G0R2() throws Exception {
		Map param = getSimpleDataMap("dma_subsearch");
		return FM0205Mapper.FM0205G0R2(param);
	}

	public List FM0205G1R0() throws Exception {
		// TODO Auto-generated method stub
		Map param = getSimpleDataMap("dma_subsearch");
		return FM0205Mapper.FM0205G1R0(param);
	}
	
	public List FM0205G2R0() throws Exception {
		return FM0205Mapper.FM0205G2R0();
	}
	
	public List FM0205G2R1() throws Exception {
		return FM0205Mapper.FM0205G2R1();
	}
	
	public List FM0205G2R2() throws Exception {
		Map param = getSimpleDataMap("dma_subsearch");
		return FM0205Mapper.FM0205G2R2(param);
	}
	
	//에어컨 제어
	public List airtubeControl() throws Exception {
		Map param = getSimpleDataMap("dma_airtubeControl");
