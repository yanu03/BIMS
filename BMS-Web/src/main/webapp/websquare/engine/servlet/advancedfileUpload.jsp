...
<script language="JavaScript">
	...
	function doInit() {
        ...
        try {
			...
			Upload_hidden_values = opener.WebSquare.language.getMessage( "Upload_hidden_values" ) || "히든값여부";
			...
			Upload_header = opener.WebSquare.language.getMessage( "Upload_header" ) || "헤더 여부";
			Upload_footer = opener.WebSquare.language.getMessage( "Upload_footer" ) || "푸터 여부";
...
<form name="__uploadForm__" method="post" action="" enctype="multipart/form-data" target="__targetFrame__">
	...
	<div class="wrap">
		...
		<div class="content">
			...
			<table id="sub" class="tbl none" summary="공백무시,히든값여부,히든채움,푸터여부,시작Row,시작col,시트no">
			<caption id="advaned">파일 업로드 고급설정</caption>
				...
				<tr>
					<th><label id="hidden_option" for="hiddenSelect" class="dot">히든값여부 :</label></th>
				...
				<tr>
					<th><label id="isHeader" for="header" class="dot">헤더 여부 :</label></th>
					<td>
					...
					<th><label id="isFooter" for="footer" class="dot">푸터 여부 :</label></th>
					<td>
